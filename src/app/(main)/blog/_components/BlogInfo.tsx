        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-lg">
              Start your content creation journey by setting up the basics
            </p>
          </div>

          <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 shadow-2xl">
            {error && (
              <div className="mb-8 p-4 bg-red-500/20 border border-red-500/30 text-red-300 rounded-xl flex items-start">
            ...
            <div className="space-y-8">
              {/* Title */}
              <div className="space-y-3">
                <label className="block text-slate-300 text-lg font-semibold">
                  Blog Title
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-4">
                  <div
                    onClick={triggerFileInput}
                    className="w-full h-48 border-2 border-dashed border-slate-600/50 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-blue-500/50 transition bg-slate-700/20 hover:bg-slate-700/30"
                  >
                    <input
                      type="file"
                      ref={fileInputRef}
                    ...
                    {isUploading ? (
                      <div className="text-center">
                        <div className="animate-spin h-12 w-12 border-4 border-blue-500/20 border-t-blue-500 rounded-full mx-auto mb-4"></div>
                        <p className="text-slate-300 font-medium text-lg">Uploading...</p>
                      </div>
                    ) : (
                      <>
                  ...
                  {blogInfo.bannerImage && !isUploading && (
                    <div className="mt-6 relative">
                      ...
                      <button
                        ...
                        className="absolute top-3 right-3 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-300 p-2 rounded-full transition-colors"
                      >
                        <X className="h-5 w-5" />
                      </button>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={blogInfo.bannerImage}
                        onChange={handleChange}
                        className="w-full pl-12 pr-4 py-4 bg-slate-700/30 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        placeholder="https://example.com/image.jpg"
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Add links to sources, references, or related content to enhance your blog
                  </p>
                </div>
                ...
                <div className="bg-slate-700/20 p-6 rounded-xl border border-slate-600/30">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full p-3 bg-slate-700/30 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        placeholder="Resource or Article Title"
                      />
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-3 py-3 bg-slate-700/30 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                          placeholder="https://example.com/resource"
                        />
                      </div>
                    </div>
                  ...
                  <button
                    type="button"
                    onClick={handleAddRefLink}
                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                    disabled={!refLink.title || !refLink.url}
                  >
                    <Plus className="h-4 w-4" />
                    <span>Add Reference</span>
                  ...
                  {blogInfo.refLinks.length > 0 && (
                    <div className="pt-6 mt-6 border-t border-slate-600/50">
                      <h4 className="font-semibold text-slate-200 mb-4 flex items-center gap-2">
                        ...
                        Added References ({blogInfo.refLinks.length}):
                      </h4>
                      <ul className="space-y-3 max-h-64 overflow-y-auto pr-2">
                        {blogInfo.refLinks.map((link, index) => (
                          <li
                            key={index}
                            className="flex items-start justify-between p-4 bg-slate-800/50 rounded-xl border border-slate-600/30"
                          >
                            <div className="flex-grow min-w-0">
                              ...
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-sm text-blue-400 hover:text-blue-300 break-all hover:underline transition-colors"
                              >
                                {link.url}
                              </a>
                            </div>
                            <button
                              type="button"
                              onClick={() => handleRemoveLink(index)}
                              className="ml-4 text-slate-400 hover:text-red-400 transition-colors p-2 rounded-lg hover:bg-red-500/10"
                            >
                              <X className="h-4 w-4" />
                            </button>
                          </li>
              ...
              <div className="pt-6 mt-6 border-t border-slate-700/50">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-4 rounded-xl transition-all shadow-xl font-bold text-lg disabled:opacity-70 disabled:cursor-not-allowed transform hover:scale-[1.02] duration-200"
                  disabled={isSubmitting || !blogInfo.title}
                >
                  {isSubmitting ? (
                    <>
                ...
                {!blogInfo.title && (
                  <p className="text-center text-slate-400 text-sm mt-3">
                    Please enter a blog title to continue
                  </p>
                )}
              </div>
            </div>
