  ...
  return (
    <header
      className={`fixed top-0 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-slate-950/95 backdrop-blur-xl shadow-lg border border-blue-500/20'
          : 'bg-slate-950/80 backdrop-blur-md border border-blue-500/10'
      } rounded-2xl mt-4 w-[95%] max-w-7xl`}
    >
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative w-10 h-10 group-hover:scale-105 transition-transform duration-300">
              <Image
                ...
                className='rounded-2xl shadow-lg shadow-blue-500/30'
              />
            </div>
            <div className="hidden sm:flex flex-col">
